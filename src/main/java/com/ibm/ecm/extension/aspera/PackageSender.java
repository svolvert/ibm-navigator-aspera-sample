...
class PackageSender {
	...
	String validateSenderCredentials(final HttpServletRequest request, final HttpServletResponse response, final Map<String, Object> packageData) throws AsperaPluginException {
